...
#Exercises: Level 3
#Point 1 - Write a function called is_prime, which checks if a number is prime.


#Point 2 - Write a functions which checks if all items are unique in the list.


#Point 3 - Write a function which checks if all the items of the list are of the same data type.


#Point 4 - Write a function which check if provided variable is a valid python variable


#Point 5 - Go to the data folder and access the countries-data.py file.
